...
- [CSDMS](https://csdms.colorado.edu) - A large, open repository of Earth-surface and environmental models (e.g., hydrology, geomorphology, climate), emphasizing model interoperability, reuse, and coupling.
- [CUAHSI](https://cuahsi.org) - Primarily a hydrologic cyberinfrastructure platform that enables sharing, discovery, and collaborative use of water data, models, and workflows through tools such as HydroShare.
- [OpenGMS](https://geomodeling.njnu.edu.cn/) - An open platform for geographic and Earth-system modeling that provides model repositories, model-sharing services, and tools for model integration and execution across geoscience domains.
